...
// jwt.ts
var rawIssuer = process.env.AUTH0_ISSUER;
var AUDIENCE = process.env.AUTH0_AUDIENCE;
var ISSUER = rawIssuer.endsWith("/") ? rawIssuer : rawIssuer + "/";
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        user: {
          ...
          country: payload["https://cruise0.example/country"] || payload["https://cruise0/country"]
        }
      })
    };
  } catch (e) {
